...
Программа считывает команды из текстового файла, выполняет их, обновляет состояние поля и
сохраняет результат в выходной файл. Поле состоит из клеток, которые могут содержать различные
 объекты: динозавра, ямы, горы, деревья, камни или цветные клетки.
